...
@Component({
  selector: 'app-sub-catagory-view',
  templateUrl: './sub-catagory-view.component.html',
  styleUrls: ['./sub-catagory-view.component.css']
})
export class SubCatagoryViewComponent implements OnInit {
